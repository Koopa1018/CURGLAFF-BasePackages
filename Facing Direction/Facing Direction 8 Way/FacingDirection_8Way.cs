...
{
	[AddComponentMenu("Character/Facing Direction 8-Way")]
	public class FacingDirection_8Way : MonoBehaviour, IFacingDirection
#if UNITY_ENTITIES
	, IConvertGameObjectToEntity
#endif
	 {
		...
		public void Convert (Entity e, EntityManager em, GameObjectConversionSystem gocs) {
			em.AddComponentData(e, new FacingDirectionComponent_8Way(Value));
		}
#endif
